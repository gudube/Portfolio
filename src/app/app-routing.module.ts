...
export interface PersonalData {
	id?: string
	title: string,
	subtitle?: string //for photography
...
class PhotographyRoute implements TypedRoute {
	constructor(id: string, city: string, country: string, photoFileNames: string[]) {
		this.path = 'photography/' + id;
		this.data = {
			seo: {
				title: `${city} (${country}) Photos | Guilhem Dubois`,
				metaTags: [
					{ name: 'description', content: `Photos from my ${city} trip in ${country}.` },
					{ property: 'og:title', content: `${city} (${country}) Photos | Guilhem Dubois`},
					{ property: 'og:description', content: `Photos from my ${city} trip in ${country}.` },
...
export const ROUTES: TypedRoutes = [
	...
	new PhotographyRoute('copenhagen', 'Copenhagen', 'Denmark', ['copenhagen-001.jpg', 'copenhagen-002.jpg', 'copenhagen-003.jpg', 'copenhagen-004.jpg', 'copenhagen-005.jpg', 'copenhagen-006.jpg', 'copenhagen-007.jpg', 'copenhagen-008.jpg', 'copenhagen-009.jpg', 'copenhagen-010.jpg', 'copenhagen-011.jpg']),
